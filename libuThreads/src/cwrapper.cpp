...
void        kThread_destroy(WkThread* kt){ delete reinterpret_cast<kThread*>(kt); }
uint64_t    kThread_get_total_number_of_kThreads(){ return kThread::getTotalNumberOfkThreads(); }
